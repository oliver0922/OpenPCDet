...
def compute_mapping(camera_to_world, coords, depth=None, intrinsic=None, image_dim=(1920, 1280)):
    """
...
def process_single_sequence(sequence_file, save_path, sampled_interval, has_label=True, use_two_returns=True, update_info_only=False, openseg_model=None):
    ...
    for cnt, data in enumerate(dataset):
        ...
        np.savez_compressed(os.path.join(cur_save_dir, f'{str(index).zfill(4)}.npz'), feat = feat_3d, mask_full = mask_full)

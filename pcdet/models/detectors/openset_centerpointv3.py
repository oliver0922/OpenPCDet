...
##################### spconv tensor끼리 학습################
CHECK_VIZ = False
class Openset_CenterPointV3(Detector3DTemplate):
    ...
    def forward(self, batch_dict):
       ...
       ########## decoder 활용해서 visualization ######################
        ...
        if CHECK_VIZ:
            ...
            plt.savefig("/home/OpenPCDet/visualization/prediction/overfit/with_bg_prediction_from_centerpt_"+str(self.loss_type)+"overfit_16.png",dpi=300, bbox_inches='tight')
            plt.axis('off')
            plt.clf() 
            plt.close('all')

...
def main():
    ...
    # os.environ["CUDA_VISBLE_DEVICES"] = 0,2,3,4,5,6,7
    ...
    if dist_train:
        model = nn.parallel.DistributedDataParallel(model,find_unused_parameters=False, device_ids=[cfg.LOCAL_RANK % torch.cuda.device_count()])
